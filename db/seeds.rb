...
bev2 = Bev.create(name:"bud light", desc:"american pilsner", cat:"beer", variety:"pilsner", cost: 5.55, lounge: lounge4)
bev3 = Bev.create(name:"blue ribbon", desc:"dive brew", cat:"beer", variety:"pilsner", cost: 2.00, lounge: lounge3)
bev4 = Bev.create(name:"whiskey rocks", desc:"whiskey on rocks", cat:"spirit", variety:"whiskey", cost: 7.00, lounge: lounge1)
bev5 = Bev.create(name:"rum coke", desc:"spiced rum with american coke", cat:"cocktail", variety:"rum", cost: 5.55, lounge: lounge1)
bev6 = Bev.create(name:"white wine", desc:"napa white wine", cat:"wine", variety:"white wine", cost: 6.00, lounge: lounge2)
bev7 = Bev.create(name:"sharks eye", desc:"belgian white", cat:"beer", variety:"white", cost: 10.00, lounge: lounge2)
bev8 = Bev.create(name:"pike ipa", desc:"super ipa from pike, high alpha level extreme bitterness rating", cat:"beer", variety:"ipa",  cost: 7.00, lounge: lounge4)
